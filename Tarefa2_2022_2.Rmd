...
Podemos inferir que existem agora, duas curvas de demanda, uma cada cada tipo de consumidor. A demanda para o consumidor $T_b$ é: $$Q^{D}_{b}(p)=50-0.5p$$ já a demanda para o consumidor $T_a$ é: $$Q^{D}_{a}(p)=35-0.25p$$.
